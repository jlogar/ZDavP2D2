...
namespace ZDavP2D2
{
    ...
    public class InvoiceAggregateRecordMapping : CsvClassMap<InvoiceAggregateRecord>
    {
        public override void CreateMap()
        {
            ...
            Map(m => m.RacZnesek).Name("Rac znesek").Index(8).TypeConverter<DecimalConverter>().TypeConverterOption("#.00");
            Map(m => m.Rac85Ddv).Name("Rac 8,5 % DDV").Index(9).TypeConverter<DecimalConverter>().TypeConverterOption("#.00");
            Map(m => m.Rac20Ddv).Name("Rac 20 % DDV").Index(10).TypeConverter<DecimalConverter>().TypeConverterOption("#.00");
            Map(m => m.PlacGot).Name("Plac got").Index(11).TypeConverter<DecimalConverter>().TypeConverterOption("#.00");
            Map(m => m.PlacKart).Name("Plac kart").Index(12).TypeConverter<DecimalConverter>().TypeConverterOption("#.00");
            Map(m => m.PlacOstalo).Name("Plac ostalo").Index(13).TypeConverter<DecimalConverter>().TypeConverterOption("#.00");
